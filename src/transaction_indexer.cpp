...
void blockchain_history_fetched(
    const std::error_code& ec, const chain::history_list& history,
...
void indexer_history_fetched(const std::error_code& ec,
    ...
    chain::history_list history, chain::blockchain::fetch_handler_history handle_fetch);
// Fetch the history first from the blockchain and then from the indexer.
void fetch_history(chain::blockchain& chain, transaction_indexer& indexer,
    const payment_address& address,
    chain::blockchain::fetch_handler_history handle_fetch, size_t from_height)
{
