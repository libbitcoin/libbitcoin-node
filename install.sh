...
build_all()
{
    ...
    build_from_github pmienk libbitcoin-network master $PARALLEL ${BITCOIN_NETWORK_OPTIONS[@]} "$@"
    build_from_travis pmienk libbitcoin-node master $PARALLEL ${BITCOIN_NODE_OPTIONS[@]} "$@"
}
