...
build_all()
{
    ...
    build_from_github pmienk libbitcoin-blockchain refactor_type $PARALLEL "$@" $BITCOIN_BLOCKCHAIN_OPTIONS
    build_from_travis pmienk libbitcoin-node refactor_type $PARALLEL "$@" $BITCOIN_NODE_OPTIONS
}
