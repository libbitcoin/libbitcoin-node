...
build_all()
{
    ...
    build_from_github libbitcoin libbitcoin-blockchain refactor_types $PARALLEL "$@" $BITCOIN_BLOCKCHAIN_OPTIONS
    build_from_travis libbitcoin libbitcoin-node refactor_types $PARALLEL "$@" $BITCOIN_NODE_OPTIONS
}
