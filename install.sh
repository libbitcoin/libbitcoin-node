...
build_all()
{
    ...
    build_from_github pmienk libbitcoin-blockchain refactor_types $PARALLEL "$@" $BITCOIN_BLOCKCHAIN_OPTIONS
    build_from_travis pmienk libbitcoin-node refactor_types $PARALLEL "$@" $BITCOIN_NODE_OPTIONS
}
