 ...
 */
#ifndef LIBBITCOIN_NODE_TRANSACTION_POOL_HPP
#define LIBBITCOIN_NODE_TRANSACTION_POOL_HPP
...
public:
    ...
    BC_API transaction_pool(threadpool& pool, chain::blockchain& chain);
    BC_API void start();
...
private:
    ...
    void reorganize(const std::error_code& ec,
        size_t fork_point,
        const chain::block_list& new_blocks,
        const chain::block_list& replaced_blocks);
    void invalidate_pool();
    void takeout_confirmed(const chain::block_list& new_blocks);
