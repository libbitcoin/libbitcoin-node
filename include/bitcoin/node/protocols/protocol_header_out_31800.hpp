...
class BCN_API protocol_header_out_31800
  : public node::protocol_peer,
    protected network::tracker<protocol_header_out_31800>
{
public:
...
protected:
    virtual bool handle_receive_get_headers(const code& ec,
        const network::messages::peer::get_headers::cptr& message) NOEXCEPT;

private:
    network::messages::peer::headers create_headers(
        const network::messages::peer::get_headers& locator) const NOEXCEPT;
};
